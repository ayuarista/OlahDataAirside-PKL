...
' Module level constants
  Private Const URL_API_Remaining  As String = "https://pdftables.com/api/remaining?key=ddlvumn18fx8"
  Private Const URL_API_PDF2Excel  As String = "https://pdftables.com/api?key=ddlvumn18fx8&format=xlsx-single"
